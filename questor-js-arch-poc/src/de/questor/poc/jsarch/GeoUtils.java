...
public class GeoUtils {
    ...
    /**
     * Computes the distance in kilometers between two points on Earth fast and simple using pythagoras.
     * For short distances it is accurate enough.
     * 
     * @param p1 First point
     * @param p2 Second point
     * @return Distance between the two points in kilometers.
     */
    public static double calcDistanceSimple (GeoPoint p1, GeoPoint p2 ) {
		double dx, dy;
		dx = 71.5 * (p1.getLongitudeE6() - p2.getLongitudeE6());
		dy = 111.3 * (p1.getLatitudeE6() - p2.getLatitudeE6());
		return (Math.sqrt(dx*dx + dy*dy)) / 1E6 ;
